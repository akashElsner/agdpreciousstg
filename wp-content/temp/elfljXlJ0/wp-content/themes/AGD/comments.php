...
* handled by a callback to purpose_comment() which is
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				...
				* to use purpose_comment() to format the comments.
				* If you want to overload this in a child theme then you can
				* define purpose_comment() and that will be used instead.
				* See purpose_comment() in organicthemes/functions.php for more.
				*/
				wp_list_comments( array( 'callback' => 'purpose_comment' ) );
			?>
		</ol>
