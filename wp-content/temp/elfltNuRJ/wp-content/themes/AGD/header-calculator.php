...
<head>
	...
	<?php wp_head(); ?>
    <!--AGD Price Calculator-->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/agd-price-calculator/agd-price-calculator.css">
    <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/agd-price-calculator/agd-price-calculator.js"></script>
            	...
            	<div class="header_table">
                    ...
                    <div class="header_table_cell header_right">
                        <div class="header_right_menu">
                            <span class="mobileMenu"><a id="menu-toggle" class="menu-toggle"><i class="fa fa-bars"></i></a></span>
                            <span><a href="<?php echo of_get_option('cta_link'); ?>"><?php echo of_get_option('cta_text'); ?></a></span>
                        </div>
                    </div>
                </div>                
            </div>
