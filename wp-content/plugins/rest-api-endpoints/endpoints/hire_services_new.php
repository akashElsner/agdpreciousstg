<?php
    function rest_hire_services_new_callback( $request ){
        ...
        if( $page_id > 0 ){
            ...
            if( isset($temp_template_slug[1]) && $temp_template_slug[1] == 'new-hire-wordpress.php' ){
                ...
                if( have_rows('hire_third_section', $page_id) ){
                 ...
                 if( have_rows('hire_second_section_api', $page_id) ){
                     while( have_rows('hire_second_section_api', $page_id) ){
                        the_row();
                            $finalArr['thirdbanner']['image'] = get_sub_field('hire_second_section_image', $page_id);
                            $finalArr['thirdbanner']['title'] = get_sub_field('hire_second_section_title_api', $page_id);
                            $finalArr['thirdbanner']['content'] = get_sub_field('hire_second_section_content_api', $page_id);
                     }
                }
