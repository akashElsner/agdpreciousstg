<?php
    function rest_update_wishlist_callback( $request  ){
        ...
        if( $user_id > 0 && $prod_id > 0 && $quantity > 0 ){
            $get_wishlist_id = get_wishlist_id($user_id);
            ...
            $data1 = $wpdb->update(
                ...
                array('prod_id' => $prod_id, 'wishlist_id' => $get_wishlist_id, 'user_id' => $user_id)
            );
