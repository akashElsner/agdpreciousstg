<?php
    ...
    function rest_partners_callback( $request ){
        ...
        $finalArr['our_partner_section']['title'] = get_field('partner_title', $page_id);
        $finalArr['our_partner_section']['subtitle'] = get_field('partner_subtitle', $page_id);
        $finalArr['our_partner_section']['content'] = get_field('partner_content', $page_id);   
        $finalArr['our_partner_section']['buttontext'] = get_field('partner_button_text', $page_id);
        $finalArr['our_partner_section']['buttonlink'] = get_field('partner_button_link', $page_id);
