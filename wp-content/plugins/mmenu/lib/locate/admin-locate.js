...
//							$h = $('<span class="mmenu-highlight" data-selector="' + $e.attr( 'data-selector' ) + '" title="Click to select"><span class="dashicons dashicons-yes"></span></span>');
							$h = $('<span class="mmenu-highlight" data-selector="' + $e.attr( 'data-selector' ) + '" title="' + mmenu_i18n.click_to_select + '"><span class="dashicons dashicons-yes"></span></span>');
		...
		function filllist( $elems )
		{
			...
			if ( !itms.length )
			{
				itms = '<li><span><em>' + mmenu_i18n.sorry_0_found + '</em></span></li>';
			}
